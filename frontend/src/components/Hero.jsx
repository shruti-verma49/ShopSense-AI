      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-28 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <button className="flex items-center gap-2 px-6 py-3 rounded-xl border border-gray-300 text-gray-700 font-medium hover:border-[#6D5DF6] hover:text-[#6D5DF6] transition-all duration-200">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            {badges.map(({ icon: Icon, label }) => (
              <div
                key={label}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50 border border-gray-200 text-sm text-gray-600"
              >
        ...
        {/* RIGHT SIDE — abstract shopping illustration */}
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 p-5"
          >
            <div className="w-full h-32 rounded-xl bg-gradient-to-br from-[#6D5DF6] to-[#5B8DEF]"></div>
            <div className="mt-4 h-3 w-3/4 rounded-full bg-gray-200"></div>
            <div className="mt-2 h-3 w-1/2 rounded-full bg-gray-100"></div>
          ...
          {/* Small floating badge card, top-right */}
          <motion.div
            animate={{ y: [0, 10, 0] }}
            transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
            className="absolute top-6 right-4 z-20 bg-white rounded-xl shadow-lg border border-gray-100 px-4 py-3 flex items-center gap-2"
          >
            <div className="w-8 h-8 rounded-full bg-[#5B8DEF]/10 flex items-center justify-center">
              <Bot size={16} className="text-[#5B8DEF]" />
            </div>
            <div>
              <div className="h-2 w-14 rounded-full bg-gray-200 mb-1"></div>
              <div className="h-2 w-10 rounded-full bg-gray-100"></div>
            </div>
          </motion.div>

          {/* Small floating badge card, bottom-left */}
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 3.8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
            className="absolute bottom-8 left-0 z-20 bg-white rounded-xl shadow-lg border border-gray-100 px-4 py-3 flex items-center gap-2"
          >
            <div className="w-8 h-8 rounded-full bg-[#6D5DF6]/10 flex items-center justify-center">
              <Star size={16} className="text-[#6D5DF6]" />
            </div>
            <div>
              <div className="h-2 w-16 rounded-full bg-gray-200 mb-1"></div>
              <div className="h-2 w-10 rounded-full bg-gray-100"></div>
            </div>
          </motion.div>
        </motion.div>
